...
# 1. Loading the raw CSV data from 2012
...
# Standardizing with original names and creating aliases for comparison with 2022 data
final_columns = [
    col("CNT"),
...
# Final DataFrame with selected columns and harmonized names
...
print(f"✅ READY! Columns: {len(df_final.columns)}, Rows: {df_final.count()}")
